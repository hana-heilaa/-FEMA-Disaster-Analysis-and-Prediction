...
def main():
    ...
    with st.sidebar:
        ...
        mode = st.radio("Choose Mode", ["Dashboard", "Test Model", "Enter Data for Prediction"])
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.markdown("<center>Developed by Rewan Abdulkareem 2025 💕</center>", unsafe_allow_html=True)
    with col2:
